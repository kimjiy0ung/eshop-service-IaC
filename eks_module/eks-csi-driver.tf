...
data "aws_iam_policy_document" "AmazonEKS_EBS_CSI_DriverRole_eshop" {
...
resource "aws_iam_role" "terra-csi" {
  assume_role_policy = data.aws_iam_policy_document.AmazonEKS_EBS_CSI_DriverRole_eshop.json
  name               = "AmazonEKS_EBS_CSI_DriverRole_eshop"
}
